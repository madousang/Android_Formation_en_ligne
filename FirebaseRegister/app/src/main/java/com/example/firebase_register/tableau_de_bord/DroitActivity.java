...
public class DroitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDure = findViewById(R.id.dureeDroit);
        TextView textRythme = findViewById(R.id.rythmeDroit);
        nameformation = findViewById(R.id.DroitTitle);
        Button btnDroitFollow = findViewById(R.id.btnDroit);

        String DURE = "5 semaines";
        textDure.setText(DURE);
        String RYTHME = "~1 heures/semaines";
...
//        passwordUser = intent.getStringExtra("password");
        btnDroitFollow.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void saveFormation() {
        ...
        if (!TextUtils.isEmpty(strNameFormation)) {
            ...
            Toast.makeText(DroitActivity.this, "Enregistrement réussi", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(DroitActivity.this, FollowingFormation.class);
