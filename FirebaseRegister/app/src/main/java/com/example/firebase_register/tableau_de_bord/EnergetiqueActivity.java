...
public class EnergetiqueActivity extends AppCompatActivity {
    private final String DURE = "8 semaines";
    ...
    private Button btnEnergieFollow;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_energetique);

        textDure = findViewById(R.id.dureeEnergetique);
        textRythme = findViewById(R.id.rythmeEnergetique);
        nameformation = findViewById(R.id.EnergetiqueTitle);
        btnEnergieFollow = findViewById(R.id.btnEnergetique);
        ...
        btnEnergieFollow.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void saveFormation() {
        ...
        if (!TextUtils.isEmpty(strNameFormation)) {
            ...
            Toast.makeText(EnergetiqueActivity.this, "Enregistrement réussi", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(EnergetiqueActivity.this, FollowingFormation.class);
